...
class Address extends React.Component {
                ...
                return (
                    <li className={val.available == 0 ? 'car-wrap invalid' : 'car-wrap' }>
                        ...
                        <div className="car-bd">
                            <div className="green"><label>地 址</label>{val.address.full}</div>
    ...
    del(index) {
        ...
        H.dialog({
            ...
            '<div class="car-bd"><div class="green"><label>地 址</label>'+data.address.full+'</div><div class="red"><label>提货码</label>' +
    ...
    edit(index) {
        ...
        let editDialog = H.dialog({
            ...
            '<div class="flex-box center green"><div class="label">收货地址</div><div class="flex-num1"><div id="chooseAddress" class="choose-address-val">'+data.address.full+'</div></div><div id="editAddress" class="choose-address-icon"></div></div>' +
            '</div></div>',
            cancelText: '关闭',
            cancel: true,
            autoClose: false,
