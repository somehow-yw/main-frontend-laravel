...
class Step1 extends React.Component {
    ...
    nextStep() {
        ...
        this.props.setStep && this.props.setStep(dataArr);
    }
        ...
        return (
            <div>
                <div className="step-bar flex-box">
                    <div className="instruct flex-num1">第一步：请批量选择提货人</div>
                    <a className="step-btn" onClick={this.nextStep.bind(this)}>下一步</a>
                </div>
