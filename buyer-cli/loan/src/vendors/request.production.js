(function(){
    ...
    server.getHome  = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=index', params, callback);
    };

    // 获取我的贷款列表
    server.getLoanList = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=lists', params, callback);
    };
    // 获取贷款信息的详情
    server.getLoanDetail = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=getInfo', params, callback);
    };
    // 获取正常还款的信息
    server.getRePayInfo = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=getRepaymentInfo', params, callback);
    };
    // 正常还款
    server.rePay = function (params, callback) {
        return send('post', '/?m=Buyers&c=Ious&a=repayment', params, callback);
    };
    // 获取转账还款的信息
    server.getTransfer = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=getRepaymentAccount', params, callback);
    };
    // 上传转账还款的凭证
    server.transfer = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=upRepaymentVoucher', params, callback);
    };

    // 获取站内信
    server.getMail = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=getInsideNotify', params, callback);
    };

    // 获取个人信息
    server.getMe = function (params, callback) {
        return send('get', '/?m=Buyers&c=Ious&a=getPersonalDetail', params, callback);
    };
    // 添加新银行卡
    server.addBank = function (params, callback) {
        return send('post', '/?m=Buyers&c=Ious&a=addBankCard', params, callback);
    };

    // 获取婚姻选项信息
    server.getMarriage = function (params, callback) {
        return send('get', '/?m=DataCenter&c=Ious&a=getMarriageCode', params, callback);
    };
    // 获取开户行编码
    server.getBankCode = function (params, callback) {
        return send('get', '/?m=DataCenter&c=Ious&a=getBankCode', params, callback);
    };
})();