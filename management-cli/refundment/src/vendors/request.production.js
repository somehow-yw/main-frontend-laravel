...
// 查询需退款订单信息;
server.order_goods_info = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=OrderMain&a=getOrderGoodsInfo', params, callback);
};

// 退款申请;
server.order_refund_apply = function(params, callback) {
    return send('post', contextPath + '/?m=Home&c=OrderMain&a=genRefundApply', params, callback);
};

// 退款记录列表;
server.order_refund_list = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=OrderMain&a=getRefundList', params, callback);
};

// 撤回退款申请;
server.order_refund_cancel = function(params, callback) {
    return send('post', contextPath + '/?m=Home&c=OrderMain&a=setRefundCancel', params, callback);
};

// 撤回退款申请;
server.admin_shop_seller_violation_types = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=Operate&a=getShopViolationTypes', params, callback);
};
