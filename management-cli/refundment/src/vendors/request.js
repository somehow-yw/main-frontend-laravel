...
server.order_goods_info = function(params, callback) {
    return send('get', contextPath + '/order/goods/info', params, callback);
};

// 退款申请;
server.order_refund_apply = function(params, callback) {
    return send('post', contextPath + '/order/refund/apply', params, callback);
};

// 退款记录列表;
server.order_refund_list = function(params, callback) {
    return send('get', contextPath + '/order/refund/list', params, callback);
};

// 撤回退款申请;
server.order_refund_cancel = function(params, callback) {
    return send('post', contextPath + '/order/refund/cancel', params, callback);
};

// 获取违规处理类型接口;
server.admin_shop_seller_violation_types = function(params, callback) {
    return send('get', contextPath + '/admin/shop/seller/violation/types', params, callback);
};
