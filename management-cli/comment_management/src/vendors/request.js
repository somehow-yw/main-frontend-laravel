...
server.order_appraise_admin_list = function(params, callback) {
    return send('get', contextPath + '/order/appraise/admin/list', params, callback);
};

// 处理列表;
server.order_appraise_admin_dispose_list = function(params, callback) {
    return send('get', contextPath + '/order/appraise/admin/dispose-list', params, callback);
};

// 处理完成接口;
server.order_appraise_admin_finish_dispose = function(params, callback) {
    return send('post', contextPath + '/order/appraise/admin/finish-dispose', params, callback);
};

// 添加处理备注接口;
server.order_appraise_admin_add_dispose = function(params, callback) {
    return send('post', contextPath + '/order/appraise/admin/add-dispose', params, callback);
};
