...
// 评价列表查询;
server.order_appraise_admin_list = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=Appraise&a=getList', params, callback);
};

// 处理列表;
server.order_appraise_admin_dispose_list = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=Appraise&a=getDisposeList', params, callback);
};

// 处理完成接口;
server.order_appraise_admin_finish_dispose = function(params, callback) {
    return send('post', contextPath + '/?m=Home&c=Appraise&a=finishDispose', params, callback);
};

// 添加处理备注接口;
server.order_appraise_admin_add_dispose = function(params, callback) {
    return send('post', contextPath + '/?m=Home&c=Appraise&a=addDispose', params, callback);
};
