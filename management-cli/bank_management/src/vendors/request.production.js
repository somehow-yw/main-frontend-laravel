...
// 评价列表查询;
server.shop_bankCard_list = function(params, callback) {
    return send('get', contextPath + '/?m=Home&c=BankCard&a=getList', params, callback);
};

// 处理列表;
server.shop_bankCard_set_info = function(params, callback) {
    return send('post', contextPath + '/?m=Home&c=BankCard&a=setBankCardInfo', params, callback);
};
