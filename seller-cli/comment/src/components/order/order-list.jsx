...
var OrderList = React.createClass({
    ...
    pays: function(param) {  //去支付;
        this.props.actionParam && this.props.actionParam(param);
    },
            ...
            <ul className="order-content">
                {
                    this.props.data.map((data, index) =>{
                        ...
                        switch (data.status){
                            case 1:
                                pri.key = <span className="privilege-text">减&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;免:</span>;
                        ...
                        return <li className="list orderlist" key={index} id={"id"+nodeId}>
                            <div className="order-list-top">
                                <div className="order-price">
                                    ...
                                    <p>{pri.priceTitle}<span className="count-price">{data.order_amount}</span></p>
                                </div>
                                {btnXml}
                            </div>
                            ...
                            {pri.shopIsShow}
                            <OrderGoodsList data={data.order_goods_infos} orderId={pri.id} delState={pri.delState} delOrderGoods={this.props.delOrderGoods} />
                        </li>
                    })
                }
            </ul>
