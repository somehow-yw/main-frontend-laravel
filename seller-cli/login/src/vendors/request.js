(function(){
    ...
    server.pushVerify = function (params, callback) {
        return send('get', '/mock/verify.json', params, callback);
    };

    // 获取市场/地址
    server.getMarket = function (params, callback) {
        if(params.type == 11) return send('get', '/mock/market.json', params, callback);
        else if(params.type == 21) return send('get', '/mock/areaAddress.json', params, callback);
    };

    // 一批上根据市场获取地址
    server.getShopAddress = function (params, callback) {
        return send('get', '/mock/address.json', params, callback);
    };
    ...
    server.upload = function (params, callback) {
        return send('get', '/mock/wechat.json', params, callback);
    };

    // 获取重开信息
    server.getReApply = function (params, callback) {
        return send('get', '/mock/old.json', params, callback);
    };
