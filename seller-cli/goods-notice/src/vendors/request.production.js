(function(){
    ...
    server.getMainGoodsTypeList = function (data, callback) {
        return send('get', 'index.php?m=Buyers&c=ShopMain&a=getMainGoodsTypeList', data, callback);
    };

    //主打商品
    server.getMainGoodsList = function (data, callback) {
        return send('get', 'index.php?m=Buyers&c=ShopMain&a=getMainGoodsList', data, callback);
    };

    //买家端展示卖家店铺信息
    server.getBuyerSellerShopInfo  = function(params, callback){
    ...
    //获取求报价详情
    server.genGoodsOrder = function (params, callback) {
        return send('get', 'index.php?m=Buyers&c=GoodsMain&a=getQuotationInfo', params, callback);
    };

    //供应商报价
    server.addSellerQuote = function (params, callback) {
        return send('post', 'index.php?m=Buyers&c=GoodsMain&a=addSellerQuote', params, callback);
    };

    //供应商下架
    server.updateQuoteSoldOut = function (params, callback) {
        return send('post', 'index.php?m=Buyers&c=GoodsMain&a=updateQuoteSoldOut', params, callback);
    };

    //求报价列表
    server.quotationList= function (params, callback) {
        return send('get', 'index.php?m=Seller&c=Quotation&a=getList', params, callback);
    };
})();