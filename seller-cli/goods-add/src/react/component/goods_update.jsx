                            ...
                            <div className="add-goods-item special-attr-wrap">
                                ...
                                <div className="cell-row" style={{height: '83px', overflow: 'hidden', alignItems: 'inherit', paddingTop: '10px'}}>
                                    <div className="cell-body">
                                        <textarea className="text-area" placeholder="优势描述" rows="4"
                                                  value={this.state.defaultPara.basic_infos.describe}
                                                  data-para="describe" onChange={this.updateValue.bind(this)}/>
                                    </div>
                                </div>
                            </div>
