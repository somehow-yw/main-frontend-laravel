...
;(function (global,factory) {
    ...
    H.operationState = function(text, time) {
        var str = '<div id="operation_state" style="position: fixed;z-index: 2002;bottom: 20%;padding: 8px 15px;' +
