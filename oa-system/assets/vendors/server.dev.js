(function () {
    ...
    var send = function (type, api, parameters, success, contentType) {
        ...
        {"Cache-Control": "no-cache", "Accept": "application/json", "Access-Control-Allow-Origin": "*"};
        var request = $.ajax({
    ...
    server.goods_type_sort = function (data, callback) {
        return send('post', contextPath + '/goods/type/sort', data, callback);
    };
    ...
    server.goods_transfer_shielding = function (data, callback) {
        return send('post', contextPath + '/goods/transfer/shielding', data, callback);
    };

    //删除操作
    server.goods_transfer_oldGoods_del = function (data, callback) {
        return send('post', contextPath + '	/goods/transfer/old-goods/del', data, callback);
    };
    ...
    server.goods_inspectionReport_picture_del = function (data, callback) {
        return send('post', contextPath + '/goods/inspection-report/picture/del', data, callback);
    };
    //商品添加;
    server.goods_add = function (data, callback) {
        return send('post', contextPath + '/goods/add', data, callback);
    };
    ...
    server.goods_audit_pass = function (data, callback) {
        return send('post', contextPath + '/goods/audit/pass', data, callback);
    };

    //审核拒绝;
    server.goods_audit_refused = function (data, callback) {
        return send('post', contextPath + '/goods/audit/refused', data, callback);
    };
    ...
    server.goods_update = function (data, callback) {
        return send('post', contextPath + '/goods/update', data, callback);
    };
    ...
    server.search_synonym = function (data, callback) {
        $.ajax({
            url: "/synonym.txt", success: function (res) {
                callback(res)
            }
        });
    };
    ...
    server.search_custom = function (data, callback) {
        $.ajax({
            url: "/custom.txt", success: function (res) {
                callback(res)
            }
        });
    };
    ...
    server.search_dict_update = function (data, callback) {
        return send('post', contextPath + '/search/custom/update', data, callback);
    };
    ...
    server.get_work_driver = function (data, callback) {
        return send('get', contextPath + '/logistics/capacitys/available', data, callback);
    };
    ...
    server.get_current_waybill = function (data, callback) {
        return send('get', contextPath + '/logistics/deliverys/' + data.id, data, callback);
    };
    // 更新运单详情
     ...
     */
        // 实时运单列表
    server.get_real_time_waybill = function (data, callback) {
        return send('get', contextPath + '/logistics/intime', data, callback);
    };
    // 获取实时运单详情
    ...
    * */
    ...
    server.logistics_charge_config_get = function(data, callback) {
        console.log(contextPath + '/logistics/charge/getconfig');
    ...
    server.version_log_add = function (data, callback) {
        return send('post', contextPath + '/system/version/log/add.json', data, callback);
    };

    //版本日志记录列表
    server.version_log_list = function (data, callback) {
        return send('get', contextPath + '/system/version/log/street.json', data, callback);
    };

    //修改版本日志记录
    server.version_log_update = function (data, callback) {
        return send('post', contextPath + '/system/version/log/update.json', data, callback);
    };
    ...
    server.get_area_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/area/list.json', data, callback);
    };

    //品牌馆列表
    server.get_brand_house_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/brands-house/list.json', data, callback);
    };

    // 下架品牌
    server.sold_out_brand = function (data, callback) {
        return send('post', contextPath + '/operation-manage/index-manage/brands-house/sold_out.json', data, callback)
    };

    // 通过id获取品牌
    server.search_brand = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/brands-house/brand_name.json', data, callback);
    };

    // 新增品牌到品牌馆
    server.add_brand_house = function (data, callback) {
        return send('post', contextPath + '/operation-manage/index-manage/brands-house/add_brand.json', data, callback);
    };

    //推荐好货列表
    server.indexManage_recommendGoods_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/recommend-goods/list.json', data, callback);
    };

    //添加推荐好货
    server.indexManage_recommendGoods_add = function (data, callback) {
        return send('get', contextPath + '	/operation-manage/index-manage/recommend-goods/add.json', data, callback);
    };

    //下架推荐好货
    server.indexManage_recommendGoods_pullOff = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/recommend-goods/pull-off.json', data, callback);
    };

    //优质供应商列表
    server.indexManage_highQualitySuppliers_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/high-quality-suppliers/list.json', data, callback);
    };

    //添加优质供应商
    server.indexManage_highQualitySuppliers_add = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/high-quality-suppliers/add.json', data, callback);
    };

    //下架优质供应商
    server.indexManage_highQualitySuppliers_pullOff = function (data, callback) {
        return send('post', contextPath + '/operation-manage/index-manage/high-quality-suppliers/pull-off.json', data, callback);
    };

    //通过id获取店铺名称
    server.indexManage_get_highQualitySuppliers_byId = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/high-quality-suppliers/search.json', data, callback);
    };

    //7添加新上好货
    server.indexManage_newGoods_add = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/new-goods/add.json', data, callback);
    };

    //8获取新上好货列表
    server.indexManage_newGoods_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/new-goods/list.json', data, callback);
    };

    //9下架新上好货
    server.indexManage_newGoods_pullOff = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/new-goods/pull-off.json', data, callback);
    };

    //10移动新上好货
    server.indexManage_newGoods_move = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/new-goods/move.json', data, callback);
    };

    //11移动优质供应商
    server.indexManage_highQualitySuppliers_move = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/high-quality-suppliers/move.json', data, callback);
    };

    //12移动推荐好货
    server.indexManage_recommendGoods_move = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/recommend-goods/move.json', data, callback);
    };

    // 获取bannerList
    server.indexManage_banner_list = function (data, callback) {
        return send('get', contextPath + '/operation-manage/index-manage/banner/list.json', data, callback);
    };
    ...
    server.bi_order = function (data, callback) {
        return send('post', 'http://localhost:8000/bi/order', data, callback);
    };

    server.bi_order_filter = function (data, callback) {
        return send('post', 'http://localhost:8000/bi/order/filter', data, callback);
    };

    server.bi_consult = function (data, callback) {
        return send('get', contextPath + '/bi/consult.json', data, callback);
    };
    ...
    server.service_list = function (data, callback) {
        return send('get', contextPath + '/service/list.json', data, callback);
    };
    server.show_service = function (data, callback) {
        return send('get', contextPath + '/service/show.json', data, callback);
    };
    server.update_service = function (data, callback) {
        return send('get', contextPath + '/service/status.json', data, callback);
    };
    server.search_service = function (data, callback) {
        return send('get', contextPath + '/service/search.json', data, callback);
    };
    server.service_log_list = function (data, callback) {
        return send('get', contextPath + '/service/logList.json', data, callback);
    };
    ...
    server.category_list = function (data, callback) {
        return send('get', contextPath + '/service/category.json', data, callback);
    };
    ...
    server.wechat_tag_list = function (data, callback) {
        return send('get', contextPath + '/service/wechatTag.json', data, callback);
    };
    ...
    server.wechat_menu_list = function (data, callback) {
        return send('get', contextPath + '/service/wechantMenu.json', data, callback);
    };
    ...
    server.get_menu_type = function (data, callback) {
        return send('get', contextPath + '/service/menuType.json', data, callback);
    };
    ...
    * */
    ...
    server.get_provider_province = function (data, callback) {
        return send('get', contextPath + '/service/province.json', data, callback);
    };
    server.get_provider_children = function (data, callback) {
        return send('get', contextPath + '/service/childrenArea.json', data, callback);
    };


    // 省市管理-列表
    server.get_market_list = function (data, callback) {
        return send('get', contextPath + '/province/provinceList.json', data, callback);
    };
    // 省市管理-详情
    server.get_market_detail = function (data, callback) {
        return send('get', contextPath + '/province/marketDetail.json', data, callback);
    };
    // 省市管理-开通省份
    server.open_province = function (data, callback) {
        return send('get', contextPath + '/province/operate.json', data, callback);
    };
    // 省市管理-开通市场
    ...
    server.get_province_list = function (data, callback) {
        return send('get', contextPath + '/province/province.json', data, callback);
    };
    // 省市管理-获取地区
    server.get_county_list = function (data, callback) {
        return send('get', contextPath + '/province/county.json', data, callback);
    };
})();