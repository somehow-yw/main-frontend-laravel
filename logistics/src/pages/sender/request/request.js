(function(){
    ...
    server.shop_address = function (data, callback) {
        return send('get', '/mock/sender/shop/address.json', data, callback);
    };

    //添加地址;
    server.shop_address_add = function (data, callback) {
        return send('get', '/mock/sender/shop/address/add.json', data, callback);
    };

    //修改地址;
    server.shop_address_update = function (data, callback) {
        return send('get', '/mock/sender/shop/address/update.json', data, callback);
    };

    //删除地址;
    server.shop_address_delete = function (data, callback) {
        return send('get', '/mock/sender/shop/address/delete.json', data, callback);
    };

    //发件;
    server.shop_order_add = function (data, callback) {
        return send('get', '/mock/sender/shop/order/add.json', data, callback);
    };

    //历史记录;
    server.shop_order = function (data, callback) {
        return send('get', '/mock/sender/shop/order.json', data, callback);
    };

    //订单详情;
    server.shop_order_ = function (data, callback) {
        return send('get', '/mock/sender/shop/order/id.json', data, callback);
    };

    //取消单个运单;
    server.shop_delivery_cancel_ = function (data, callback) {
        return send('get', '/mock/sender/shop/delivery/cancel/id.json', data, callback);
    };

    //地址输入提示;
    server.map_search_hint = function (data, callback) {
        return send('get', '/mock/sender/map/search/hint.json', data, callback);
    };

    //逆地址解析;10
    server.map_geocode_regeo = function (data, callback) {
        return send('get', '/mock/sender/map/geocode/regeo.json', data, callback);
    };
