...
class ActionSheet extends React.Component{
    ...
    //剩下的两种支付方式集成处理（银行卡和支付宝）等客服确认 返回一个支付信息。payInfo 要将结果集返回。
    payWay(param) {
        let server  =  H.server, 
            $loading  =  $('#actionsheet-loading'), 
            p  =  {};
            ...
            <div id = 'actionSheet_wrap'>
                ...
                <div className = 'actionsheet' id = 'actionsheet'>
                    ...
                    <div className = 'actionsheet_action'>
                        <div className = 'actionsheet_cell' id = 'actionsheet_cancel' onTouchStart = {this.cancel.bind(this)}>关闭</div>
                    </div>
                </div>
            </div>
        );
