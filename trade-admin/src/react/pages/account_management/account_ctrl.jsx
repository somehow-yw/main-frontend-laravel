...
class AccountManagementCtrl extends React.Component {
    ...
    createUser() {
        let info = {
            ...
            user_name: '',
            login_name: '',
            department_id: this.state.departmentList[0].id,
            login_password: ''
        };
        this.setState({
            infoItem: info,
    ...
    modifyPermissionsSub() {
        ...
        for(let i = 0 ; i < chooseArr.length ; i++) {
            if(chooseArr.eq(i).attr('name')) {
                arr.push(chooseArr.eq(i).attr('name'));
            }
        }
        param.privilege_tags = arr.join(',');
    ...
    userPrivilege() {
        let navigates = this.state.infoItem.privileges.navigates,
            ...
            oneXml = [];
        if(navigates == '' || !navigates || !executePrivilege[1]) return;
                ...
                case 2:
                    modalXml = (
                        <Modal
                            ...
                            header="操作权限"
                            confirm="确定"
                            confirmCallback={this.closeModal}
                            closeCallback={this.closeModal}
                        >
                            {this.userPrivilege()}
                        </Modal>
                        ...
                        <div className="info-main-w">
                            <div className="infoPanel-form">
                                ...
                                <div className="item"><label>登录账号：</label>
                                    ...
                                    <span style={{color: 'red', marginLeft: '10px'}}>必须是手机号</span>
                                </div>
